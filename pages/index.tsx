        ...
        <Box maxWidth="1000px" px="30" w="100%" position="relative">
              ...
              >
                <Box overflow="hidden" rounded="full">
                  <Image
                    rounded="full"
                    w="8"
                    src="/assets/landing/hashitout.jpeg"
                    alt="HashItOut"
                  />
                </Box>
                <Text fontFamily="secondary" fontWeight="light">
                  Building @ Hash it out S2
                </Text>
              </Flex>
            </Flex>
            <Text
          ...
          <Box>
            <Text
              ...
              opacity={0.75}
            >
              Storix is a decentralized file storage and synchronization
          ...
          <Box>
            ...
            >
              ...
              "Drag & drop a file here – no central authority, just you and your file!"
              </Text>
            </Flex>
          </Box>
        </Box>
